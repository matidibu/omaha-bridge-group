...
const STORAGE_KEY = 'obg-welcome-v4'
...
const STEPS: { icon: string; color: string; title: string; body: React.ReactNode }[] = [
  {
    icon: '♥',
    color: '#D46060',
    title: 'Seis maestros del value investing',
    body: <>Buffett, Lynch, Greenblatt, Taleb, Marks y Fink analizan cualquier acción. Cada uno desde su filosofía. Vos ves el consenso.</>,
  },
  {
    icon: '★',
    color: '#8BA4C0',
    title: 'Veredicto con precio objetivo y stop-loss',
    body: <>Calificación <span translate="no">Strong Buy → Sell</span>, precio objetivo, <span translate="no">stop-loss</span> y ratio <span translate="no">riesgo/recompensa</span>. Para largo y corto plazo.</>,
  },
  {
    icon: '♦',
    color: '#C9A84C',
    title: 'Datos reales · Algoritmo determinístico',
    body: <>Balances, flujos de caja, indicadores técnicos y datos macro de la Reserva Federal. Sin inventar. Sin sesgo.</>,
  },
]
